...
public class RouteSpecificationTest {
	...
	Voyage hongKongTokyoNewYork = new Voyage.Builder(new VoyageNumber("V001"), SampleLocations.HONGKONG)
		.addMovement(SampleLocations.TOKYO, LocalDateTime.now().minusYears(1).plusMonths(2).plusDays(1),
				LocalDateTime.now().minusYears(1).plusMonths(2).plusDays(5))
		.addMovement(SampleLocations.NEWYORK, LocalDateTime.now().minusYears(1).plusMonths(2).plusDays(6),
				LocalDateTime.now().minusYears(1).plusMonths(2).plusDays(10))
		.addMovement(SampleLocations.HONGKONG, LocalDateTime.now().minusYears(1).plusMonths(2).plusDays(11),
	...
	Voyage dallasNewYorkChicago = new Voyage.Builder(new VoyageNumber("V002"), SampleLocations.DALLAS)
		...
		.addMovement(SampleLocations.CHICAGO, LocalDateTime.now().minusYears(1).plusMonths(2).plusDays(12),
	...
	public void testIsSatisfiedBySuccess() {
		RouteSpecification routeSpecification = new RouteSpecification(SampleLocations.HONGKONG,
				SampleLocations.CHICAGO, LocalDate.now().minusYears(1).plusMonths(3).plusDays(1));
	...
	public void testIsNotSatisfiedByMissedDeadline() {
		RouteSpecification routeSpecification = new RouteSpecification(SampleLocations.HONGKONG,
				SampleLocations.CHICAGO, LocalDate.now().minusYears(1).plusMonths(2).plusDays(15));
