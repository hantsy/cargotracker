 ...
 * specification changes, or the cargo is assigned to a new route. In that case, the
 * delivery update is performed synchronously within the cargo aggregate.
 *
 * <p>
...
public class Cargo {
	...
	public String toString(boolean verbose) {
		return verbose ? Objects.toString(this, "tacking id:" + trackingId.toString()) : trackingId.toString();
	}
