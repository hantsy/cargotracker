...
@JMSDestinationDefinition(name = "java:app/jms/CargoHandledQueue", interfaceName = "jakarta.jms.Queue",
		destinationName = "CargoHandledQueue")
@JMSDestinationDefinition(name = "java:app/jms/MisdirectedCargoQueue", interfaceName = "jakarta.jms.Queue",
		destinationName = "MisdirectedCargoQueue")
@JMSDestinationDefinition(name = "java:app/jms/DeliveredCargoQueue", interfaceName = "jakarta.jms.Queue",
		destinationName = "DeliveredCargoQueue")
@JMSDestinationDefinition(name = "java:app/jms/RejectedRegistrationAttemptsQueue", interfaceName = "jakarta.jms.Queue",
...
@JMSDestinationDefinition(name = "java:app/jms/HandlingEventRegistrationAttemptQueue",
		interfaceName = "jakarta.jms.Queue", destinationName = "HandlingEventRegistrationAttemptQueue")
@ApplicationScoped
